...
namespace DaceItFront.Controllers
{
    public class MatchesController : Controller
    {
        ...
        public MatchesController(DaceitContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdMatch,StartDate,Duration")] Match match)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdMatch,StartDate,Duration")] Match match)
        {
            if (id != match.IdMatch)
            {
                return NotFound();
